...
import { onSelectSlot, onSelectEvent, onSelectView } from '../store/appSlice';
import { rbcEventsSelector } from '../store/eventsSlice';
import { getSmartDates } from '../utils/rbc';
import styles from '../styles/RbcWrapper.module.css';
